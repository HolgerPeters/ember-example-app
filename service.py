...
p1 = Person(name="Ernie", email="ernie@example.com", birthdate=datetime.date.today())
p2 = Person(name="Bert", email="bert@example.com", birthdate=datetime.date.today())
p2 = Person(name="Elmo", email="elmo@example.com", birthdate=datetime.date.today())
c1 = Computer(serial="abcdefg-01")
c2 = Computer(serial="abcdefg-02")
c3 = Computer(serial="abcdefg-03")
p1.computers.append(c1)
p1.computers.append(c2)
p2.computers.append(c3)
db.session.add(p1)
db.session.add(p2)
db.session.commit()
